  ...
  export default {
    ...
    data() {
      return {
        ...
        cid_value:"",
        rank_value:4,
        comment_value:"走在风中集团年言刚看了啊该额回国啦耳机割了肉般若结果阿尔吧二哥二娃软件噶二零儿儿而实和二十六二轮" +
                "二个客人管理局二割了肉是给二十来个了人事科挂机了人生结果旅客人数管理色弱尽量客观热水鹅嘎儿给reg" +
                "儿管理客人就概括了人个人了儿科了r"
      };
    },
    methods: {
        ...
        api.getPage(pageIndex, this.queryForm.customerId).then(res => {
          ...
          for(let i=0;i<this.tableData.length;i++){
            switch (this.tableData[i].status) {
              ...
              case 4:this.tableData[i].status="已退单"; break;
            }
          }
        });
      },
